...
$(function() {
	...
	testGadgets = [host + '/portal/gadgets/co2-emission/co2em.xml', host + '/portal/gadgets/agricultural-land/agri.xml', host + '/portal/gadgets/electric-power/electric-power.xml', host + '/portal/gadgets/energy-use/energy-use.xml', host + '/portal/gadgets/greenhouse-gas/greenhouse-gas.xml'];
	drawGadgets();
});
...
var getNewGadgetElement = function(result, gadgetURL) {
	...
	$('#gadgetArea-' + curId + ' .portlet-header').html(gadgetTitle + gadgetSettings);
